      ...
      <div class="rounded-lg border border-design bg-card p-4">
        ...
        <div class="grid grid-cols-2 gap-3 mb-3">
          <div>
            ...
            <input v-model.number="pctDiff.old" type="number" placeholder="0" class="input-field">
          </div>
          <div>
            <label class="block text-xs font-medium text-secondary mb-1">New</label>
            <input v-model.number="pctDiff.new" type="number" placeholder="0" class="input-field">
          </div>
        </div>
